...
const roomsAddSchema = yup.object().shape({
  roomname: yup
    .string()
    .trim()
    .min(4, 'Too short')
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
      <MainLayout>
        ...
        <Formik
          ...
          validationSchema={roomsAddSchema}
          onSubmit={handleEdit}>
          {({handleSubmit, values}) => {
            console.log(values);
            return (
              <Fragment>
                <View style={styles.container} onPress={handleDropdown}>
                  <View>
                    <Text style={styles.subHead}>Create Your Room</Text>
                  </View>
                  ...
                  <Input
                    ...
                    autoCorrect={false}
                  />
                  <NextBtnSubmit buttonTitle="Create Room" />
                </View>
              </Fragment>
            );
          }}
